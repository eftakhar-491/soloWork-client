...
const AddJob = () => {
  ...
  function handelAddjob(e) {
    e.preventDefault();
    const formItems = new FormData(e.target);
    const formData = Object.fromEntries(formItems.entries());
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-306px)] my-12">
      <section className=" p-2 md:p-6 mx-auto bg-white rounded-md shadow-md ">
        <h2 className="text-xl text-center font-bold text-gray-700 capitalize ">
          Post a Job
        </h2>
